...
// //No es un verbo http, es un use() el cual se ejecuta para todas las rutas
// //use() espera la async func con 3 parámetros: req, res, next
// //creamos un obj log, con la info que nos llega en el req, 
// //(ip, method, originalUrl, headers.origin, headers.['user-agent'] etc.)
// // Try de insert it en la tabla logs de la BBDD
// //catch del error
// //next al siguiente middleware o ruta


// //!Haz las vistas 
// // Carpeta donde pondrás tus templates
...
// //!HAREMOS UNA TABLA DESDE EL BACK, DONDE PINTAREMOS LOS LOGS. 
// //!entonces necesitamos traerlos desde la base de datos
// 3. //TODO: Ruta para ver logs (protégela en producción)
// //este si es un verbo http, de tipo get, necesitamos una RUTA
// //traeremos hasta los 100 primeros registros de la tabla logs 
// // ordenados desde los mas recientes hasta los mas antiguos (escendientes).
// // manejar errores y enviar la respuesta con los datos obtenidos
